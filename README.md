...
| `docs/01-审批结果复刻范围.md` | 用户审批后的范围生成物；不替代当前产品优先级 |
| `docs/02-第一版模块边界.md` | 范围生成物中的保留/可选/后置/不做；不替代当前产品优先级 |
| `docs/03-开发执行顺序.md` | 历史生成的开发顺序；当前任务只认交接快照与任务包 |
...
| `docs/guides/local-development.md` | 本地启动 PostgreSQL、Redis、后端和前端 |
