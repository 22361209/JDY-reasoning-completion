<template>
  <DocumentForm
    ...
    @select-party-option="document.selectPartyOption($event, 'other-stock-in-party')"
...
import { useOtherStockInDocument } from "./useOtherStockInDocument";
...
const document = useOtherStockInDocument({
...
function noop() {}
function noopReturn() {
  return "other-stock-in-no-push-dialog";
}
