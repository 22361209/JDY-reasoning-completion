<template>
  <DocumentForm
    ...
    @select-party-option="document.selectPartyOption($event, 'other-stock-out-party')"
...
import { useOtherStockOutDocument } from "./useOtherStockOutDocument";
...
const document = useOtherStockOutDocument({
