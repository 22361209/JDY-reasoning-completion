<template>
  <DocumentForm
    ...
    :show-target-warehouse-column="document.showTargetWarehouseColumn.value"
    ...
    @select-party-option="document.selectPartyOption($event, 'stock-transfer-party')"
...
import { useStockTransferDocument } from "./useStockTransferDocument";
...
const document = useStockTransferDocument({
...
function noop() {}
function noopReturn() {
  return "stock-transfer-no-push-dialog";
}
