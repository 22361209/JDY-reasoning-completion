...
const lifecyclePolicyByType: Record<DocumentType, Omit<DocumentLifecyclePolicy, "type">> = {
  ...
  salesReturn: DEFAULT_FACT_POLICY,
  ...
  productionTask: { closeFreezeAllowed: true, lineCloseFreezeAllowed: true, redReverseAllowed: false, voidAllowed: true },
  materialIssue: { closeFreezeAllowed: false, lineCloseFreezeAllowed: false, redReverseAllowed: true, voidAllowed: true },
  materialScrap: { closeFreezeAllowed: false, lineCloseFreezeAllowed: false, redReverseAllowed: false, voidAllowed: true },
