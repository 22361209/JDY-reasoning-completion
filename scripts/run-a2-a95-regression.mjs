...
const baselinePath = path.join(rootDir, "verification/a2-a94-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a95-regression-latest.json");
const expectedMinimum = 83;
...
const summary = {
  ...
  note: "A95 full suite: A94 baseline plus reverse-to-draft editable/re-auditable lifecycle and workbench next bill number regression.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a95-regression-latest.json"
}, null, 2));
