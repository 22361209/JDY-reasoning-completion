...
const baselinePath = path.join(rootDir, "verification/a2-a92-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a93-regression-latest.json");
const expectedMinimum = 81;
...
const summary = {
  ...
  note: "A93 full suite: A92 baseline plus sales out direct pushdown and source selection regression.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a93-regression-latest.json"
}, null, 2));
