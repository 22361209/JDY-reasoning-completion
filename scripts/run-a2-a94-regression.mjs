...
const baselinePath = path.join(rootDir, "verification/a2-a93-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a94-regression-latest.json");
const expectedMinimum = 82;
...
const summary = {
  ...
  note: "A94 full suite: A93 baseline plus tax exclusive/inclusive line tax and finance posting tax-total regression.",
  results
};
