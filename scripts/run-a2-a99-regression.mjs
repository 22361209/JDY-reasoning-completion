...
const baselinePath = path.join(rootDir, "verification/a2-a98-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a99-regression-latest.json");
const expectedMinimum = 87;
...
const summary = {
  ...
  note: "A99 full suite: A98 baseline plus global density alignment for list tables, entry tables, master/source selector dialog tables and compact action hierarchy.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a99-regression-latest.json"
}, null, 2));
