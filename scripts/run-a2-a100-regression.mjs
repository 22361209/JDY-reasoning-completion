...
const baselinePath = path.join(rootDir, "verification/a2-a99-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a100-regression-latest.json");
const expectedMinimum = 88;
...
const summary = {
  ...
  note: "A100 full suite: A99 baseline plus purchase order to purchase in direct draft pushdown, retired push confirmation dialog, and purchase in line-level multi-source assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a100-regression-latest.json"
}, null, 2));
