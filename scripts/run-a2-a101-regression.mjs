...
const baselinePath = path.join(rootDir, "verification/a2-a100-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a101-regression-latest.json");
const expectedMinimum = 89;
...
const summary = {
  ...
  note: "A101 full suite: A100 baseline plus stock alert safety threshold settings and low safety stock list assertion.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a101-regression-latest.json"
}, null, 2));
