...
const baselinePath = path.join(rootDir, "verification/a2-a105-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a106-regression-latest.json");
const expectedMinimum = 92;
...
const summary = {
  ...
  note: "A106 full suite: A105 baseline plus shared DataListPage document detail-view toggle and one-entry-per-row assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a106-regression-latest.json"
}, null, 2));
