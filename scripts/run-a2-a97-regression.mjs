...
const baselinePath = path.join(rootDir, "verification/a2-a96-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a97-regression-latest.json");
const expectedMinimum = 85;
...
const summary = {
  ...
  note: "A97 full suite: A96 baseline plus shared entry/list table UX, source selector search/select-all/column settings and list drag ghost regression.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a97-regression-latest.json"
}, null, 2));
