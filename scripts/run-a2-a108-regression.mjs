...
const baselinePath = path.join(rootDir, "verification/a2-a107-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a108-regression-latest.json");
const expectedMinimum = 94;
...
const summary = {
  ...
  note: "A108 full suite: A107 baseline plus delivery notice mandatory flow, reserved stock and available stock assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a108-regression-latest.json"
}, null, 2));
