...
const baselinePath = path.join(rootDir, "verification/a2-a87-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a89-regression-latest.json");
const expectedMinimum = 73;
...
const summary = {
  ...
  note: "A89 full suite: A87 73-script baseline plus A88 stock-count chain and A89 sales-order detail pushdown path.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a89-regression-latest.json"
}, null, 2));
