...
const baselinePath = path.join(rootDir, "verification/a2-a106-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a103-regression-latest.json");
...
const summary = {
  ...
  note: "A103 full suite: A2-A106 baseline plus customer/product price memory assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a103-regression-latest.json"
}, null, 2));
