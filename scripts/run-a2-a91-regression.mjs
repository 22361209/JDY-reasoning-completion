...
const baselinePath = path.join(rootDir, "verification/a2-a90-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a91-regression-latest.json");
const expectedMinimum = 79;
...
const summary = {
  ...
  note: "A91 full suite: A90 baseline plus frontend UX shared DataListPage and EntryTable regression.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a91-regression-latest.json"
}, null, 2));
