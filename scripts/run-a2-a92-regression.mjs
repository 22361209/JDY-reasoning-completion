...
const baselinePath = path.join(rootDir, "verification/a2-a91-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a92-regression-latest.json");
...
const summary = {
  ...
  note: "A92 full suite: A91 baseline plus sales document customer/creator/plan delivery/header remark/pushdown carry regression.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a92-regression-latest.json"
}, null, 2));
