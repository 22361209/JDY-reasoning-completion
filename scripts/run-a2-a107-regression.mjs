...
const resultPath = path.join(rootDir, "verification/a2-a107-regression-latest.json");
const expectedMinimum = 93;
...
const summary = {
  ...
  note: "A107 full suite: A106 baseline plus shared DataListPage/EntryTable table-structure assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a107-regression-latest.json"
}, null, 2));
