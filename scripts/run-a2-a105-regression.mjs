...
const baselinePath = path.join(rootDir, "verification/a2-a102-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a105-regression-latest.json");
const expectedMinimum = 91;
...
const summary = {
  ...
  note: "A105 full suite: A102 baseline plus bill lifecycle close/unclose, freeze/unfreeze, hardened void, downstream block, and pushdown skip assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a105-regression-latest.json"
}, null, 2));
