...
const baselinePath = path.join(rootDir, "verification/a2-a89-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a90-regression-latest.json");
const expectedMinimum = 78;
...
const summary = {
  ...
  note: "A90 full suite: A89 77-script baseline plus A90 backend numbering and direct sales-out default clearing.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a90-regression-latest.json"
}, null, 2));
