...
const baselinePath = path.join(rootDir, "verification/a2-a108-regression-latest.json");
const resultPath = path.join(rootDir, "verification/a2-a110-regression-latest.json");
const expectedMinimum = 95;
...
const summary = {
  ...
  note: "A110 full suite: A108 baseline plus shared table display, horizontal-scrollbar and BLD branding assertions.",
  results
};
...
console.log(JSON.stringify({
  ...
  resultPath: "verification/a2-a110-regression-latest.json"
}, null, 2));
