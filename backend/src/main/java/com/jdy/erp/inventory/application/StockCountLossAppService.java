...
public class StockCountLossAppService {
    ...
    private static final BillLifecycleTarget LIFECYCLE_TARGET = new BillLifecycleTarget(BILL_TABLE, "stock_count_loss_line", "bill_id", "INVENTORY", "stock_count_loss");
    ...
    private void insertLines(Object billId, List<StockCountLossLineRequest> lines) {
        ...
        for (var line : lines) {
            ...
            jdbcTemplate.update("""
                INSERT INTO stock_count_loss_line (bill_id, line_no, product_id, product_code_snapshot, product_name_snapshot, product_spec_snapshot, warehouse_id, source_line_no, qty, unit_price, amount, line_remark)
    ...
    public record StockCountLossLineRequest(String productId, String productCode, String warehouseCode, Integer sourceLineNo, BigDecimal qty, BigDecimal unitPrice, String lineRemark) {
    }
}
