...
public class StockCountGainAppService {
    ...
    public StockCountGainAppService(JdbcTemplate jdbcTemplate, LookupService lookupService, ValidationService validationService, BillLifecycleService lifecycleService, PostingPipeline postingPipeline, NumberingService numberingService) {
    ...
    private void insertLines(Object billId, List<StockCountGainLineRequest> lines) {
        ...
        for (var line : lines) {
            ...
            jdbcTemplate.update("""
                INSERT INTO stock_count_gain_line (bill_id, line_no, product_id, warehouse_id, source_line_no, qty, unit_price, amount, line_remark)
    ...
    public record StockCountGainLineRequest(String productCode, String warehouseCode, Integer sourceLineNo, BigDecimal qty, BigDecimal unitPrice, String lineRemark) {
    }
}
