...
本文件只回答代码和脚本“在哪里、哪些能改、做完怎么验”。文档阅读顺序、当前状态和任务预算以 `docs/README.md`、`docs/09-交接清单.md`、`docs/12-当前批次验收清单.md` 与 `AGENTS.md` 为准。

## 开工先读

先按 `docs/README.md` 选择现行规范，再读取当前任务涉及的代码、对应模块协议和回归 helper；不要把本文件当作第二份交接清单。
