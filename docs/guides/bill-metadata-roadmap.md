...
- 物料编码/物料名称、客户编码/客户名称、客户物料号、供应商编码等规则集中声明。
...
- 客户编码、客户名称、客户物料号、预计交期、物料编码、物料名称等规则集中在定义层。
...
- 供应商编码、供应商名称、物料字段、预计交期、入库状态等由定义层驱动。
- 采购模块不加客户订单号/客户物料号。
...
- 物料保留“一物料多业务面”：可采购、可销售、可库存、可自制、可委外、默认仓库、默认供应商、默认领料仓、默认生产车间等。
- 客户/供应商不作为通讯录，而作为交易规则主数据：地址、联系人、结算、开票、信用、冻结/禁用边界保留。
- 维护客户/供应商物料号映射的定义入口。
